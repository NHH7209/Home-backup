...
// html 웹 문서 동작
// 1) 컴퓨터 웹브라우저에 html 문서르 읽어들임(파싱 : 문법 해석)
// 2) 파싱된 문서(DOM) -> 메모리에 저장(DOM 저장됨)
// 파싱된 문서(DOM) : 트리구조(자료구조)
// 예) html 현재 문서(03 _dom.detail.html)

// ============ 트리 구조로 나타내면 ============
//             window(최상위 부모객체: html 문서, 주소창, 상태바 등)
//                | 
//             document(객체, html 문서)
//                |
//             html 
...
//                      --------------------------------------
//                      |                                    |
// div(태그) - style="backgroundColor ='aqua'"(속성)    scrupt - src="./js/03_dom_detail.js"
//                      | 
//                 "안녕하세요"(텍스트, innerHTML)

// DOM 트리구조가 이렇다라는 것을 알아라
