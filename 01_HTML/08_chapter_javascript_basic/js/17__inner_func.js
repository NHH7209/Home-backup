...
// console.log(str.substring(4,8)); //4,5,6,7 까지 보임
...
// console.log("str2", str2);
// let str3 = str.toLowerCase(); //소문ㄴ자 바꾸기
...
// // 절대값 : 음수 -> 양수
// // 사용법 : Math.abs(음수) -> 양수
// console.log("Math.abs", Math.abs(5.3));
...
let month = date.getMonth() + 1; //월 (0 ~ 11) 0부터 시작하기에 1을 더해야한다.
