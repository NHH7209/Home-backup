...
FROM EMPLOYEE; -- 에러 (일반컬럼(ENAME), MAXS(SALARY) 같이 사용 못함
...
--       2) 직급별(JOB) 총액 구하기
-- 힌트 ) 1) 직급별(JOB) 총액 구하기
--        2) MANAGER인 값 제외(조건1) : WHERE
--        3) 급여(SALARY) 총액(SUM)이 5000 이상이 상원(조건2) : HAVING
