...
function App() {
  return (
    <div className="App">
      {/* 자식 컴포넌트 추가 */}
      {/* <A_Comment></A_Comment> */}
      {/* <B_Comment_Exam></B_Comment_Exam> */}
      {/* <C_Comment_Exam2></C_Comment_Exam2> */}
      {/* <D_CommentList></D_CommentList> */}
      {/* <E_CommentList_Exam></E_CommentList_Exam> */}
      <F_CommentList_Exam2></F_CommentList_Exam2>
    </div>
  );
}
